...
<body class="hold-transition login-page" style="overflow-y: hidden;background:url(
	'<?php echo base_url('assets_style/image/buku-4.jpg');?>')no-repeat center;background-size:95%;">
<div class="login-box">
	<br/>
  ...
  <footer>
    <div class="login-box-body text-center bg-blue">
       <a style="color: White;"> Kelompok 4 &copy; Aplikasi Sistem Informasi Perpustakaan <?php echo date("Y");?>
    </div>
  </footer>
</div>
<!-- /.login-box -->
